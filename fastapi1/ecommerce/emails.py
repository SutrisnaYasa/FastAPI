    ...
    <html>
        ...
        <body>
            <div style = "display: flex; align-items: center; justify-content: center; flex-direction: column">
                ...
                <p>Thanks for choosing Shop, please click on the button below to verify your account </p>
                ...
                <p>Please kindly ignore this email if you did not register for Shop and nothing will happend. Thank you</p>
            </div>
        </body>
    </html>
    """
